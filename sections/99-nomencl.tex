% \footnotesize
% \nomenclature{$\vec w$}{весовой вектор, вектор бимформинга, beamforming vector}
% \nomenclature{$\vec W$}{кодовая книга, codebook}
% \nomenclature{$\vec s$}{диаграмообразующий вектор, steering vector}
