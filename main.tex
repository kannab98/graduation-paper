...
% \title{Оценка угла прихода сигнала на приемной антенне пользователя в миллиметровом канале связи}


% \NirReportName{Выпускная квалификационная работа}

\TitleWorkTitle{Оценка угловой координаты источника излучения в миллиметровом канале связи стандарта 5G NR}
\begin{document}
